export class MapAnnotations {
  ...
  createCircle(x, y) {
    ...
    container.addEventListener('click', (e) => {
      ...
      const index = this.circles.findIndex((circleData) => circleData.element === container);
  ...
  createArrow(startX, startY, endX, endY) {
    ...
    arrow.addEventListener('click', (e) => {
      ...
      const index = this.arrows.findIndex((arrowData) => arrowData.element === arrow);
...
export function initializeMapControls(mapAnnotations) {
  ...
  clearAnnotationsButton.addEventListener('click', () => {
    while (mapAnnotations.annotationsContainer.firstChild) {
      mapAnnotations.annotationsContainer.removeChild(mapAnnotations.annotationsContainer.firstChild);
    }
  ...
  titleBar.addEventListener('mousedown', (event) => startDragging(event, mapContainer));
